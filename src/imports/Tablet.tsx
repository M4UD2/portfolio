...
function Frame2() {
  return (
    <div className="content-stretch flex flex-col gap-[8px] h-[108px] items-end justify-center leading-[normal] not-italic opacity-80 relative shrink-0 text-black w-full">
      <p className="font-['Space_Mono:Bold',sans-serif] h-[22px] relative shrink-0 text-[16px] w-full">[Yrden] De 60 minutos de espera a um onboarding produtivo</p>
      <p className="font-['Space_Mono:Regular',sans-serif] h-[44px] relative shrink-0 text-[14px] w-full">Um case sobre como transformei uma limitação técnica em uma jornada de boas-vindas de valor</p>
...
function ProjectPreview() {
  return (
    <div className="absolute content-stretch flex flex-col gap-[24px] h-[344px] items-start left-[120px] right-[120px] top-[837px]" data-name="project preview">
...
function Frame6() {
  return (
    <div className="content-stretch flex flex-col gap-[24px] items-center justify-center relative shrink-0 w-full">
      <div className="font-['Space_Mono:Bold',sans-serif] leading-[normal] not-italic relative shrink-0 text-[#212529] text-[32px] text-center w-[375px]">
        <p className="mb-0">{`Oi, eu sou a Lívia! `}</p>
        <p>Bem-vindo(a) ao meu portfólio ;)</p>
      </div>
      <div className="code-behavior-wrapper flex relative shrink-0 tailwind w-[375px]">
        <div className="font-['Space_Mono:Regular',sans-serif] leading-[0] not-italic relative text-[#212529] text-[14px] text-center w-[375px]">
...
function Frame5() {
  return (
    <div className="absolute content-stretch flex flex-col gap-[220px] items-center left-[calc(16.67%+71.67px)] top-[196px] w-[391px]">
      <Frame6 />
      <Frame4 />
    </div>
  );
...
function Anchor() {
  return (
    <div className="absolute h-0 left-[-119.5px] top-[448px] w-[1040px]" data-name="anchor">
...
function Frame3() {
  return (
    <div className="content-stretch flex flex-col gap-[8px] h-[108px] items-end justify-center not-italic opacity-80 relative shrink-0 text-black w-full">
      <p className="font-['Space_Mono:Bold',sans-serif] h-[22px] leading-[normal] relative shrink-0 text-[16px] w-full">Axiom - Implementando múltiplas visualizações</p>
      <p className="font-['Space_Mono:Regular',sans-serif] h-[44px] leading-[normal] relative shrink-0 text-[14px] w-full">Um case sobre como transformei uma limitação técnica em uma jornada de boas-vindas de valor</p>
      <a className="block font-['Space_Mono:Regular',sans-serif] leading-[0] relative shrink-0 text-[14px] w-full" href="https://www.figma.com/design/1oBmsrGt3Bp95wCtUwVcaD?node-id=3-419">
        <p className="[text-underline-position:from-font] cursor-pointer decoration-solid leading-[normal] underline">Confira →</p>
      </a>
    </div>
  );
}
...
function ProjectPreview1() {
  return (
    <div className="absolute bottom-[190px] content-stretch flex flex-col gap-[24px] h-[344px] items-start left-[120px] right-[120px]" data-name="project preview">
      <div className="h-[344px] relative rounded-[24px] shrink-0 w-full">
        <img alt="" className="absolute inset-0 max-w-none object-50%-50% object-cover pointer-events-none rounded-[24px] size-full" src={imgRectangle1} />
      </div>
      <Frame3 />
...
function MeusUltimosProjetos() {
  return (
    <div className="absolute h-[24px] left-[calc(25%+85px)] top-[712px] w-[206px]" data-name="Meus últimos projetos">
...
export default function Tablet() {
  return (
    <div className="bg-[#f8f9fa] relative size-full" data-name="Tablet">
      <ProjectPreview />
      <Frame5 />
      <Anchor />
      <ProjectPreview1 />
      <div className="absolute h-0 left-[-1166px] top-[797.5px] w-[699.5px]">
        <div className="absolute bottom-[-0.5px] left-0 right-0 top-[-0.5px]">
          <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 700 1">
            <path d="M0 0.5H699.5" id="Vector 3" stroke="var(--stroke-0, black)" />
          </svg>
        </div>
      </div>
      <MenuCelular />
