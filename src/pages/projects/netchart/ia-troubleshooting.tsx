        ...
        <div className="max-w-[1040px] mx-auto px-6 md:px-10 py-8 md:py-12">
          <div className="flex flex-col gap-16">
            ...
            <Section id="cenario" title="Cenário e problema">
              ...
              <p>
                Essa lacuna gerava uma imensa <strong>sobrecarga cognitiva</strong> e fadiga nos engenheiros. Como eles precisavam interromper constantemente o fluxo no NetChart para buscar respostas em manuais externos, o processo de investigação tornava-se lento e exaustivo. Como consequência, a causa raiz dos problemas muitas vezes só era totalmente compreendida quando algum parâmetro já apresentava uma <strong>sobrecarga cognitiva</strong> na qualidade da rede.
              </p>
            </Section>
            ...
            <Section id="descoberta" title="Descoberta">
              ...
              <p>
                Com essa dor mapeada, definimos com o time de Ciência de Dados que a <strong>IA Generativa</strong> seria a tecnologia ideal para <strong>traduzir os desvios de parâmetros diretamente em causas raiz e instruções de resolução.</strong>
              </p>
              ...
              <GoalResultCard
                goal={<>Como poderíamos reduzir o esforço de investigação técnica, mantendo o engenheiro focado no fluxo de análise?</>}
            ...
            <Section id="impacto" title="Impacto projetado">
              ...
              <BulletList items={[
                <><strong>Resultados Projetados:</strong> Através dos testes de usabilidade validados com os usuários, estimamos uma redução de <strong>70% no tempo de troubleshoot</strong> (ao eliminar a busca manual em documentações) e um aumento de <strong>30% na adoção proativa</strong> (solucionando anomalias antes que virem crises na rede).</>,
              ]} />
